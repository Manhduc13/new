...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 32056 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 48719 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 47794 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 90068 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 18407 };
      job.tasks = [task];
      const employee: IEmployee = { id: 44985 };
      job.employee = employee;
