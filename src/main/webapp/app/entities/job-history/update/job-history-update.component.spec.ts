...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 80577 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 20265 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 88558 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 47442 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 43487 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 18983 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 39792 };
      jobHistory.job = job;
      const department: IDepartment = { id: 61030 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 9887 };
      jobHistory.employee = employee;
